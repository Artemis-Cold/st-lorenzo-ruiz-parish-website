...
export default function BookingManagement() {
  ...
  const handleExportPdf = () => {
    ...
    doc.setFontSize(14);
    doc.text(`Booking Management — ${activeType}`, 14, 16);
    ...
    autoTable(doc, {
      startY: 28,
      head: [
        ["ID", "Date", "Name/s", "Contact No.", "Type", "Amount", "Status"],
      ],
    ...
    doc.save(`bookings-${activeType.toLowerCase().replace(/\s+/g, "-")}.pdf`);
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-white/75">
                  Total Listed Bookings: {bookings.length}
                </p>
              </div>
            </div>
