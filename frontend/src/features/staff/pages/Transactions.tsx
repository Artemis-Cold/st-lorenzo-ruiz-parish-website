...
export default function Transactions() {
  ...
  const changeStatus = async (
    ...
    try {
      ...
      toast.error(
        requestMessage(error, "Unable to update the payment status."),
      );
    } finally {
      setProcessing(false);
    }
      ...
      <div className="space-y-6 sm:space-y-8">
          ...
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-[minmax(250px,1fr)_180px_190px_180px_auto]">
            <label className="relative block">
              ...
              <input
                ...
                placeholder="Search reference, name, contact, or receipt..."
            ...
            <label>
              ...
              <select
                ...
                onChange={(event) => {
                  setLoading(true);
                  setService(event.target.value as TransactionService | "");
                  setPage(1);
                }}
                className="h-11 w-full rounded-xl border border-[#E7E2DA] bg-white px-3 text-sm text-gray-700 outline-none transition focus:border-[#B22222]"
              >
        ...
        <section className="overflow-hidden rounded-3xl border border-[#E7E2DA] bg-white shadow-sm">
          ...
          <p className="border-b border-[#EFEAE3] px-5 py-2 text-[11px] text-gray-400 xl:hidden">
            Swipe or scroll sideways to view payment details. The review action
            remains pinned.
          </p>
          <div
