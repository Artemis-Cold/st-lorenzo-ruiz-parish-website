  ...
  return (
    <StaffDashboardLayout>
      <div className="space-y-6">
        <div className="overflow-hidden rounded-3xl bg-linear-to-br from-[#B22222] to-[#741515] px-8 py-9 text-white shadow-lg">
        ...
        <section className="overflow-hidden rounded-3xl border border-[#E7E2DA] bg-white shadow-sm">
          ...
          <div className="divide-y divide-gray-100">
            ...
            >
              <div className="grid size-12 shrink-0 place-items-center rounded-xl bg-red-50 text-[#B22222]">
                <UserRound size={22} />
              </div>
            ...
            <button
              ...
              className="group flex w-full items-center gap-4 px-6 py-5 text-left transition hover:bg-[#FAF8F5] sm:px-8"
            >
              <div className="grid size-12 shrink-0 place-items-center rounded-xl bg-amber-50 text-amber-700">
                <LockKeyhole size={22} />
              </div>
              <div className="min-w-0 flex-1">
                <p className="font-semibold text-[#292524]">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Change the password for your staff account.
                </p>
              </div>
              <ChevronRight
                size={20}
            ...
            <button
              ...
              className="group flex w-full items-center gap-4 px-6 py-5 text-left transition hover:bg-[#FAF8F5] sm:px-8"
            >
              <div className="grid size-12 shrink-0 place-items-center rounded-xl bg-blue-50 text-blue-700">
                <UserPlus size={22} />
              </div>
              <div className="min-w-0 flex-1">
                <p className="font-semibold text-[#292524]">Add Parish Staff</p>
                <p className="mt-1 text-sm text-gray-500">
                  Create credentials for another authorized staff member.
                </p>
              </div>
              <ChevronRight
                size={20}
            ...
            <button
              type="button"
              onClick={() => navigate("/staff/settings/pricing")}
              className="group flex w-full items-center gap-4 px-6 py-5 text-left transition hover:bg-[#FAF8F5] sm:px-8"
            >
              <div className="grid size-12 shrink-0 place-items-center rounded-xl bg-emerald-50 text-emerald-700">
                <Banknote size={22} />
              </div>
              <div className="min-w-0 flex-1">
      ...
      {activeModal === "profile" && (
        <SettingsModal
          ...
          description="Update the details shown across the staff portal."
          onClose={closeModal}
          wide
        >
          <form onSubmit={saveProfile} noValidate className="space-y-6">
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-gray-100 pt-5 sm:flex-row sm:justify-end">
              ...
              <button
                type="submit"
                disabled={saving}
                className="rounded-xl bg-[#B22222] px-5 py-3 font-semibold text-white hover:bg-[#991B1B] disabled:opacity-50"
              >
      ...
      {activeModal === "password" && (
        <SettingsModal
          ...
          description="Use your current password to authorize this change."
          onClose={closeModal}
        >
            ...
            {(
              ...
              <label key={key} className="block text-sm font-medium">
                ...
                <input
                  ...
                  className={`${inputClass(Boolean(passwordErrors[key]))} mt-2`}
                />
      ...
      {activeModal === "staff" && (
        <SettingsModal
          title="Add Parish Staff"
          description="Create a new account for an authorized parish staff member."
          onClose={closeModal}
          wide
        >
