        ...
        <div className="mb-6 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Event dates and times will appear on public parish calendars.
            </p>
          </div>
          <button
            type="button"
            ...
            disabled={submitting}
            aria-label="Close"
            className="grid size-10 shrink-0 place-items-center rounded-full text-gray-500 hover:bg-gray-100 disabled:opacity-50"
          >
            <X size={20} />
          </button>
        </div>
        ...
        <form onSubmit={submit} noValidate className="space-y-5">
          ...
          <label className="block text-sm font-medium text-gray-700">
            ...
            <textarea
              ...
              placeholder="Describe the event and anything parishioners should prepare."
