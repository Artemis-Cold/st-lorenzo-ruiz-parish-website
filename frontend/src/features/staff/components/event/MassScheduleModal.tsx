  ...
  return (
    ...
    >
      <section
        role="dialog"
        aria-modal="true"
        aria-labelledby="mass-schedule-title"
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <h2
                id="mass-schedule-title"
                className="mt-1 font-serif text-2xl font-bold text-[#292524]"
              >
                Add Monthly Masses
              </h2>
              <p className="mt-1 text-sm leading-5 text-gray-500">
                Generate the regular Mass schedule for an entire month.
              </p>
            </div>
          </div>
          <button
            ...
            disabled={submitting}
            aria-label="Close"
            className="grid size-9 shrink-0 place-items-center rounded-full text-gray-500 hover:bg-gray-100 disabled:opacity-50"
          >
            <X size={19} />
          </button>
        </div>
        ...
        <div className="mt-6 rounded-2xl border border-amber-100 bg-amber-50/70 p-4 text-sm text-amber-950">
          ...
          <dl className="mt-3 space-y-2 text-xs leading-5">
            <div className="flex justify-between gap-4">
              <dt className="text-amber-800">Monday–Saturday</dt>
              <dd className="font-semibold">6:00 AM</dd>
            </div>
            <div className="flex justify-between gap-4">
              <dt className="text-amber-800">Sunday</dt>
              <dd className="text-right font-semibold">
                6:00 AM, 9:00 AM, 4:30 PM
              </dd>
            </div>
          </dl>
        </div>
        ...
        <form onSubmit={submit} noValidate className="mt-6 space-y-5">
          ...
          <label className="block text-sm font-medium text-gray-700">
            ...
            <input
              ...
              placeholder="e.g. Main Parish Church"
          ...
          <p className="rounded-xl bg-gray-50 px-4 py-3 text-xs leading-5 text-gray-500">
            Existing Mass entries for the selected month will be skipped
            automatically, so this action is safe to run again.
          </p>
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-gray-100 pt-5 sm:flex-row sm:justify-end">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex items-center justify-center gap-2 rounded-xl bg-[#B22222] px-5 py-3 font-semibold text-white hover:bg-[#991B1B] disabled:opacity-50"
            >
              <CalendarPlus size={17} />
              {submitting ? "Adding Masses..." : "Add Mass Schedule"}
            </button>
          </div>
        </form>
      </section>
