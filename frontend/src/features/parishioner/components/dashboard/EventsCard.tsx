      ...
      {announcements.length === 0 ? (
        ...
        <div className="space-y-5">
          {announcements.map((announcement) => (
            <article
              key={announcement.id}
              className="rounded-2xl border border-gray-100 p-5 transition hover:border-red-100 hover:shadow-md"
            >
              <div className="flex flex-wrap items-start justify-between gap-3">
                <h3 className="font-serif text-xl font-bold text-[#292524]">
                  {announcement.title}
                </h3>
              ...
              <p className="mt-4 text-xs font-medium text-[#B22222]">
