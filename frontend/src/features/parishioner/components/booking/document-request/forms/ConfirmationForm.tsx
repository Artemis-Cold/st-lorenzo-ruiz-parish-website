  ...
  return (
    <div className="grid grid-cols-12 gap-5">
      ...
      <div className="col-span-12 md:col-span-6">
        <label className="mb-2 block text-sm font-medium">
          Date of Confirmation <span className="text-red-600">*</span>
        </label>
        ...
        <input
          ...
          className={
            inputClass +
            (getError("confirmation_date") ? " border-red-400" : "")
          }
          readOnly={readOnly}
          value={
            details.confirmation_date
              ? details.confirmation_date.toISOString().split("T")[0]
              : ""
          }
          onChange={(e) =>
            updateRequest(
        ...
        />
        <FieldError message={getError("confirmation_date")} />
      </div>
    </div>
  );
}
