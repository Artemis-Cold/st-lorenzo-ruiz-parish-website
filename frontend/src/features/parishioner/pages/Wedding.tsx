  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <BookingCard title="Requirements">
          <div className="space-y-6">
            <p className="text-gray-600">
              Please prepare the following requirements before proceeding with
              ...
              <div className="space-y-8">
                ...
                <div className="rounded-xl border border-gray-200 p-5">
                  ...
                  <p className="mt-2 text-gray-700">
                    Kapag galing sa ibang parokya ang ikakasal (ibibigay ng opisina kapag natapos ang interview)/ Canonical Investigation
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-gray-200 p-5">
                  ...
                  <p className="mt-2 text-gray-700">
                    Both the bride and groom are encouraged to receive the
                    Sacrament of Reconciliation before the wedding day.
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-gray-200 p-5">
                  ...
                  <ul className="mt-3 list-disc space-y-2 pl-6 text-gray-700">
                    ...
                    <li>
                      Indicate the couple's names, wedding address, wedding
                      date, day, and time.
                    </li>
                  </ul>
                </div>
        ...
        <BookingFooter previousText="Back" nextText="Continue to Packages" />
      </div>
    </DashboardLayout>
  );
}
